...
public class Spigboard {
    ...
    /**
     * Initiate a scoreboard with the provided title.
     * 
     * @param title
    ...
    public SpigboardEntry add(String name, int value) {
        return add(name, name, value, true);
    }
    ...
    private Map<Integer, String> create(String name) {
        // Bukkit.getLogger().info("Name: '" + name + "' (" + name.length() + ")
        ...
        while (contains(name)) {
            ...
            count++;
            // Bukkit.getLogger().info("Name: '" + name + "' (" + name.length()
            // + ") contains? " + contains(name) + " (" + ++count + ")");
        }

        if (name.length() > 48) {
            name = name.substring(0, 47);
            // Bukkit.getLogger().info("Name: '" + name + "' (" + name.length()
            // + ") contains? " + contains(name) + " (trim)");
        }
