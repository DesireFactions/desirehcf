...
public class FriendListGUI extends ItemGUI {
    ...
    public FriendListGUI(DesireCore instance, Player p) {
        super(null, p, 54);
    }
    ...
    public void registerItems() {
        ...
        for (UUID uuid : session.getFriends()) {
            ...
            String status = DesireCore.getInstance().getServer().getPlayer(uuid) == null ? ChatColor.RED + "[OFFLINE]" : ChatColor.GREEN + "[ONLINE]";
